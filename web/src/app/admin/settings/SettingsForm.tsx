      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like DataMagic to retain chat messages. Leaving this field empty will cause DataMagic to never delete chat messages."
